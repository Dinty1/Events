module.exports = [
    ...
    {
        id: 'Agility',//the id that you'll use for all your command blocks
        friendlyName: 'Agility',//friendly name that the challenge is known by
        discordResultMessages: [
            {
                channelName: "%name%-private",
                content: "You have just completed the %friendlyName% task with a time of %time%. Continue making the IFFD proud!"
        ...
        googleSheetNewRows: [//rows to add to the google spreadsheet
            {
                sheetName: 'Agility',//sheet name - case sensitive!
                row: ['%name%', '%time%', "%ms%"]//going across, the cells in the sheet
            },
        ],
        leaderboard: ''//the leaderboard to refresh when the timer is stopped
